	    ...
	    <div class ="header_middle">
               <a href="#"><img class="image2" id="header_img_con" src="images/images.png"></a>
				...
				<div id="header">
					...
					<a href="../sign_up/index.php"><button id="get_login_home_button">SIGN UP</button></a>
...
<div id="log_form">
	    	<form action="form.php" method="POST">
	            ...
	            <table id="sort" width="900" align="center">
	               ...
	               <tr align="center">                            
                        <td colspan="5" id="log_log"><h2>LOGIN</h2></td>
                   </tr>  
				 ...
				 <tr>
				 	<td><br><input type="hidden" name="rem_pass_cookie" value="" /></td id="rem"><td><br>
				 		<input class="checkbox" type="checkbox" name="rem_pass_cookie" value="" /><b>&nbsp;Remember me
				 	<span id="forgot_pass_sty"><a href=""><b>Forgot Password</b></a></span> 


				 	</b></td>
				 </tr>
                  <tr align="center">
	                            <td colspan="5"  ><br><input id="sign_table_sub" type="submit" name="mail_submit" value="LOGIN"></td>
	                   </tr>
			    </table>
			</div>
			</form>
